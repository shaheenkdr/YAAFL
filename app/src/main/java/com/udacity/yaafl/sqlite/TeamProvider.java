package com.udacity.yaafl.sqlite;
...
public class TeamProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.udacity.yaafl.sqlite.TeamProvider";
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "teams/#", TEAM_ID);
    }
    ...
    static final String DATABASE_NAME = "football";
    ...
    public Uri insert(Uri uri, ContentValues values) {
         ...
         */
        long rowID = db.insert(TEAMS_TABLE_NAME, "", values);
    ...
    public int update(Uri uri, ContentValues values,
        ...
        switch (uriMatcher.match(uri)) {
            case TEAMS:
                count = db.update(TEAMS_TABLE_NAME, values, selection, selectionArgs);
                break;

            case TEAM_ID:
                count = db.update(TEAMS_TABLE_NAME, values,
